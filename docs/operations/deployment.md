...
1. Confirm CI restore, build, publish, dependency inventory, container image inventory, container build, tests, vulnerability scan, static source security scan and secret scan passed.
