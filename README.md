...
The GitHub Actions workflow runs restore, Release build, API/Web publish, transitive package inventory, API/Web container builds, tests, NuGet package vulnerability checks and common secret pattern checks on `main` and pull requests. See `docs/operations/security-gates.md`.
