...
- GitHub Actions CI for restore, build, publish, container builds, tests, vulnerability checks and basic secret scanning.
...
The GitHub Actions workflow runs restore, Release build, API/Web publish, API/Web container builds, tests, NuGet package vulnerability checks and common secret pattern checks on `main` and pull requests. See `docs/operations/security-gates.md`.
