...
public sealed class EntityFrameworkProjectRepository : IProjectRepository
{
    ...
    private static KnowledgeItemRecord ToRecord(KnowledgeItem item)
    {
        return new KnowledgeItemRecord
        {
            ...
            SourceChunkNumber = item.SourceChunkNumber,
            ExtractionProvider = item.ExtractionProvider,
            ExtractionModel = item.ExtractionModel,
            ExtractionUsedFallback = item.ExtractionUsedFallback,
    ...
    private static KnowledgeItem ToDomain(KnowledgeItemRecord record)
    {
        return KnowledgeItem.Rehydrate(
            ...
            record.SourceChunkNumber,
            record.ExtractionProvider,
            record.ExtractionModel,
            record.ExtractionUsedFallback,
