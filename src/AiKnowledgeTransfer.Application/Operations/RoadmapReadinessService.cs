    ...
    private static IReadOnlyCollection<RoadmapPhaseReadinessResponse> BuildPhases()
    {
        ...
        [
            ...
            NeedsWork(
                ...
                8,
                [
                    "Monitoring, backups, release readiness, DB providers, security gates, dependency SBOM, build artifact file hashes, container checks, container provenance, role review and tenant isolation review are implemented.",
                    "SQL Server and PostgreSQL are configurable production-capable database providers."
                ],
                [
                    "Enterprise-hardening follow-ups remain: registry-backed image signing enforcement, standards-complete CycloneDX/SPDX SBOM attestation, direct secret-manager integration, blue/green deployment and complete tenant isolation."
                ])
        ];
    }
