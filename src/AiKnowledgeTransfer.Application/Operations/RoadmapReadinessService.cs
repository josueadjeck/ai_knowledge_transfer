    ...
    private static IReadOnlyCollection<RoadmapPhaseReadinessResponse> BuildPhases()
    {
        ...
        [
            ...
            NeedsWork(
                ...
                [
                    "Enterprise-hardening follow-ups remain: platform-specific registry push/sign/verify automation, external SBOM attestation retention, automated provider-specific secret retrieval and shared multi-tenant isolation."
                ])
        ];
    }
